//! Clean-room implementation of the MPCache graph transformation described by R23.
...
mod tests {
    use super::*;
    use pllm_models::{lower_model_json, lower_qwen_decoder, DecoderWorkload, QwenConfig};
