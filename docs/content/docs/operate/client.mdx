---
title: "Python client"
description: "Construct the native PLLM client, inspect its resources, and choose it instead of the gateway only when your process owns the private client boundary."
---
