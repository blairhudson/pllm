---
title: "Reimplementation backlog"
description: "What PLLM will reproduce, implement, review, and measure next."
---
...
1. **Complete one protected Qwen composition.** Close every semantic, numeric,
   protected, placement, state, and token-feedback gap using explicit component
   contracts. The compiler must continue to reject partial coverage.
