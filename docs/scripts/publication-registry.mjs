...
const declaredPublicationRegistry = {
  ...
  pages: [
    ...
    ...cliCommandPages,
    page('pllm.docs.reference.python.pllm', 'content/docs/reference/python/pllm/index.mdx', '/reference/python/pllm', 'reference', { publicModules: ['pllm', 'pllm.config', 'pllm.models', 'pllm.plan', 'pllm.components', 'pllm.correlation', 'pllm.kernels', 'pllm.nonlinear', 'pllm.passes', 'pllm.profiles', 'pllm.providers', 'pllm.protocols', 'pllm.protocols.masked_linear', 'pllm.preparation', 'pllm.roles', 'pllm.schedulers', 'pllm.sources', 'pllm.state', 'pllm.verification', 'pllm.pipeline', 'pllm.deployment', 'pllm.runtime', 'pllm.compiler', 'pllm.evidence'], sourcePaths: ['content/docs/reference/python/pllm/index.mdx', '../python/pllm'], testPaths: ['../tests/test_developer_reference.py'] }),
    page('pllm.docs.reference.components', 'content/docs/reference/components.mdx', '/reference/components', 'reference', { publicModules: ['pllm.components', 'pllm.correlation', 'pllm.kernels', 'pllm.nonlinear', 'pllm.passes', 'pllm.preparation', 'pllm.protocols', 'pllm.roles', 'pllm.schedulers', 'pllm.state', 'pllm.verification'], publicSymbols: ['get', 'get_component', 'list_component_classes', 'list_components'], componentIds: ['pllm/bfv-correlations/v1', 'pllm/binary-table/v1', 'pllm/blinded-linear/v1', 'pllm/chunked-independent-lanes/v1', 'pllm/cleartext-linear', 'pllm/client-local-kv', 'pllm/cpu', 'pllm/direct-fhe', 'pllm/guarded-linear/v1', 'pllm/he-authenticated-preprocessing', 'pllm/independent-lanes/v1', 'pllm/inference', 'pllm/kv-cache-eviction', 'pllm/linear-integrity', 'pllm/masked-linear', 'pllm/model-aware-corrections', 'pllm/r03-crt/v1', 'pllm/scalar/v1', 'pllm/secure-linear/v1', 'pllm/seeded-expansion'], sourcePaths: ['content/docs/reference/components.mdx', '../python/pllm/components/__init__.py'], testPaths: ['../tests/test_component_families.py', '../tests/test_developer_reference.py'] }),
