...
const declaredPublicationRegistry = {
  ...
  pages: [
    ...
    ...cliCommandPages,
    page('pllm.docs.reference.python.pllm', 'content/docs/reference/python/pllm/index.mdx', '/reference/python/pllm', 'reference', { publicModules: ['pllm', 'pllm.config', 'pllm.models', 'pllm.plan', 'pllm.components', 'pllm.correlation', 'pllm.kernels', 'pllm.nonlinear', 'pllm.passes', 'pllm.profiles', 'pllm.protocols', 'pllm.protocols.masked_linear', 'pllm.preparation', 'pllm.roles', 'pllm.schedulers', 'pllm.sources', 'pllm.state', 'pllm.verification', 'pllm.pipeline', 'pllm.deployment', 'pllm.runtime', 'pllm.compiler', 'pllm.evidence'], sourcePaths: ['content/docs/reference/python/pllm/index.mdx', '../python/pllm'], testPaths: ['../tests/test_developer_reference.py'] }),
