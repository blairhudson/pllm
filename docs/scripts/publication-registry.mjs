...
const declaredPublicationRegistry = {
  ...
  pages: [
    ...
    ...cliCommandPages,
    page('pllm.docs.reference.python.pllm', 'content/docs/reference/python/pllm/index.mdx', '/reference/python/pllm', 'reference', { publicModules: ['pllm', 'pllm.config', 'pllm.models', 'pllm.plan', 'pllm.components', 'pllm.kernels', 'pllm.protocols', 'pllm.protocols.masked_linear', 'pllm.preparation', 'pllm.pipeline', 'pllm.deployment', 'pllm.runtime', 'pllm.compiler', 'pllm.evidence'], sourcePaths: ['content/docs/reference/python/pllm/index.mdx', '../python/pllm'], testPaths: ['../tests/test_developer_reference.py'] }),
    page('pllm.docs.reference.components', 'content/docs/reference/components.mdx', '/reference/components', 'reference', { publicModules: ['pllm.components'], publicSymbols: ['list_components', 'get_component'], componentIds: ['pllm/cpu', 'pllm/gated-multiply-q7', 'pllm/kv-cache-eviction', 'pllm/masked-linear', 'pllm/model-aware-corrections', 'pllm/protected-tensor-schedule'], sourcePaths: ['content/docs/reference/components.mdx', '../python/pllm/components/__init__.py'], testPaths: ['../tests/test_developer_reference.py'] }),
