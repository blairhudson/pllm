...
All figures here come from the supplied lifecycle study. This documentation build does not introduce a new inference benchmark. Download [the raw summary](/downloads/lifecycle-summary.json) and [evidence records](/downloads/evidence.zip).
