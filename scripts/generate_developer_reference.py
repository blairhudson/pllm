...
CLI_ROOT_ORDER = ("gateway", "serve", "config", "components", "benchmark", "research", "dev")
CLI_EXAMPLES = {
...
def render_cli_reference(
    ...
    body = [
        ...
        "transport, inspect configuration, and work with research records. Open "
        "[Private inference](/cli/private-inference/), [Provider roles](/cli/provider-roles/), "
        "[Benchmarking](/cli/benchmarking/), or "
        "[Inspect and research](/cli/inspect-and-research/). Choose a command group below for "
