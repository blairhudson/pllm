...
CLI_ROOT_ORDER = ("config", "components", "benchmark", "research", "dev")
CLI_EXAMPLES = {
    ...
    "pllm research sources list": "pllm research sources list --format json",
    "pllm research sources show": "pllm research sources show R01",
    "pllm research methods list": "pllm research methods list --format json",
    "pllm research methods show": (
        "pllm research methods show pllm.method.mpcache-structural-adaptation.v1"
    ),
    "pllm research recipes list": "pllm research recipes list --format json",
    "pllm research recipes show": "pllm research recipes show R01",
    "pllm research assess": (
        "pllm research assess examples/publication-assessment.json --format json"
    ),
    "pllm research agents": "pllm research agents --output AGENTS.md",
    "pllm benchmark run": (
...
def render_research_catalog() -> str:
    ...
    for item in catalog["recipes"]:
        ...
        evidence = (
            ...
            if item.get("workflow_status") == "not_executed"
            else _cell(item.get("required_evidence"))
        )
        body.append(
            "| "
            + " | ".join(
